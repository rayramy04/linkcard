export default {
  profile: {
    ...
    bio: "Studying Computer Science and Data Science in Malaysia 🇲🇾",
  ...
  about: {
    ...
    paragraphs: [
      ...
      "並行して業界最大級の留学メディアを立ち上げ、IT・音楽フリーランスとしても活動。SNSフォロワー2.5万人超。国内外でのインターン、15か国以上への旅、格闘技から象使いの免許取得まで、常に新たな挑戦を続けている。",
      "━━━", // separator line
      ...
      "Alongside my studies, I founded one of the industry's largest study abroad media platforms and work as an IT/music freelancer. 25,000+ social media followers. From internships to 15+ countries traveled, martial arts to mahout license, I continuously embrace new challenges."
    ]
  }
};